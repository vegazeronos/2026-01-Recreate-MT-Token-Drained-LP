...
interface IPancakeV2Router is IPancakeRouter01 {
...
interface IAAVE_V3 {
    function flashLoanSimple(address receiver, address token, uint256 amount, bytes memory params, uint16 referralCode)
        external;
}
